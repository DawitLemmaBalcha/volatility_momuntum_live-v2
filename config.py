...
CONFIRMATION_RSI_PERIOD = 60
CONFIRMATION_VOLUME_MA_PERIOD = 60
ATR_TRAILING_STOP_MULTIPLIER = 0.4147227758145075

#----------------------------------------------

POSITION_DEGRADING_FACTOR = 0.5
...
RSI_BUY_CONFIRMATION = 65
RSI_SELL_CONFIRMATION = 35
...
MAX_POSITION_DURATION_SECONDS = 43200
